...
//해당 상황에 대한 판단을 위해 Sample1, Sample2 파일을 통한 예시로 확인해봅시다.
    ...
    void Update()
    {
        ...
        //프로그램 내에서 핵심적으로 계속 사용되는 메인 로직을 짜는 위치로 사용되비다.
        ...
        //따라서 업데이트에서 무조건 실행되야하는 상황이 아니라면 다른 영역에서 작업을 하게 설계하는 것이
        //업데이트의 부담을 줄여줄 수있고 이게 성능의 향상으로 이어집니다.
    ...
    private void LateUpdate()
    {
        ...
        //LateUpdate가 여러 개일 경우 상황에 맞는 호출 순서가 중요합니다.
